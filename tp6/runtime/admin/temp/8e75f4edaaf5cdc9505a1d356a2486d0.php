<?php /*a:1:{s:78:"C:\Users\Falcon\Desktop\phpEnv\www\api.tp6.com\app\admin\view\index\index.html";i:1601201319;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>富豪博彩 - 后台管理系统</title>
    <meta name="keywords" content="富豪">
    <meta name="description" content="棋牌后台">
    ...
    <link rel="stylesheet" href="/static/admin/css/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="/static/admin/css/themes/default.css" media="all">
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var result = "http://" + document.location.host + "/admin/menu";
        var clear = "http://" + document.location.host + "/admin/clear";
        var options = {
            iniUrl: result,    // 初始化接口
            clearUrl: clear, // 缓存清理接口
